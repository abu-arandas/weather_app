...
class ForecastWidget extends StatelessWidget {
  ...
  const ForecastWidget({super.key, required this.forecast, required this.isCelsius});
      ...
      content: SingleChildScrollView(
        child: Column(
          children: [
            ...
            // - Temperature
            Text(
              '${forecast.avgTemperature.toStringAsFixed(0)} $tempUnit',
              textAlign: TextAlign.center,
            ...
            Row(
              ...
              children: [
                const Text('Min: '),
                Text(
                  '${forecast.minTemperature.toStringAsFixed(0)} $tempUnit',
                  style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold),
                ),
                const Text('  |  ', style: TextStyle(fontSize: 24)),
                const Text('Max: '),
                Text(
                  '${forecast.maxTemperature.toStringAsFixed(0)} $tempUnit',
                  style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold),
                ),
              ],
            ),
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          children: [
                            ...
                            // - Temperature
                            Text(
                              '${forecast.hours[index].temperature.toStringAsFixed(0)} $tempUnit',
                              style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold),
                            ),
