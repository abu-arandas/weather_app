          ...
          appBar: AppBar(
            ...
            actions: [
              ...
              IconButton(
                ...
                icon: Icon(weatherProvider.isCelsius
                    ? Icons.thermostat
                      ...
                      builder: (context, child) {
                        return ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            final location =
                                _locationsProvider.locations[index];
                            return ListTile(
                              title: Text(location),
                              onTap: () {
                                weatherProvider.callWeatherAPi(
                                    current: false, cityName: location);
          ...
          body: SingleChildScrollView(
            ...
            child: Column(
              children: [
                ...
                Image.asset(
                  weatherProvider
                      .getWeatherImage(weatherProvider.weather!.description),
                  height: 150,
                  width: 150,
                  fit: BoxFit.fill,
                ),
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              children: [
                                // - Image
                                Image.asset(
                                  weatherProvider.getWeatherImage(
